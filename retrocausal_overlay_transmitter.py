...
# Render the 32×32 color grid as a PIL image (8K UHD: 7680×4320)
OUTPUT_WIDTH = 7680
OUTPUT_HEIGHT = 4320
CELL_W = OUTPUT_WIDTH // GRID_SIZE   # 240 px per cell (horizontal)
CELL_H = OUTPUT_HEIGHT // GRID_SIZE  # 135 px per cell (vertical)
...
print(f"Saved {output_path} ({OUTPUT_WIDTH}x{OUTPUT_HEIGHT} px, {GRID_SIZE}x{GRID_SIZE} grid, cells {CELL_W}x{CELL_H} px)")
